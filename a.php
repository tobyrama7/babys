...
function change(){
        ...
        $no = trim(fgets(STDIN));
        $data = '{"email":"'.$email.'@gmail.com","name":"'.$nama.'","phone":"+62'.$no.'","signed_up_country":"ID"}';
        ...
        echo "\n".color("nevy","?] Mau Redeem Voucher?: y ");
        $pilihan = "y" ;
        if($pilihan == "y" || $pilihan == "Y"){
        echo color("red","===========(REDEEM VOUCHER)===========");
        echo "\n".color("yellow","!] Claim voc PULPY2000");
        ...
        sleep(3);
        $boba11 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":""}');
        ...
        sleep(3);
        $goride = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"BIARKAMUGABOSEN"}');
        ...
        $expired4 = getStr1('"expiry_date":"','"',$cekvoucher,'4');
         setpin:
         echo "\n".color("nevy","?] Mau set pin?: y");
         $pilih1 = "y" ;
         if($pilih1 == "y" || $pilih1 == "Y"){
         //if($pilih1 == "y" && strpos($no, "628")){
         echo color("red","========( PIN ANDA = 123321 )========")."\n";
         $data2 = '{"pin":"123321"}';
